...
The shellcode generated by our program comes up around 70 bytes in size which I think is not bad considering that the shellcodes from [shell-storm](https://www.shell-storm.org/shellcode/) and [exploit-db](https://www.exploit-db.com/shellcodes/) were of varying sizes but mostly all greater than 70 bytes and the main purpose of a writing a shellcode for exploitation purposes is making it as small as possible.
